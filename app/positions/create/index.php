...
<div class="container">
  ...
  <form action="../utils/create.php" method="POST" class="fit-content mx-auto">
    <input type="text" name="name" placeholder="Megnevezés" class="form-input mx-auto" required />
    <textarea class="form-input" name="description" placeholder="Leírás" rows="4" cols="50" maxlength="4000"></textarea>
